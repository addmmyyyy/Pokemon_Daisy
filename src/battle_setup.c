...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_D_OLIVER,TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
...
{
    CreateMaleMon(&gEnemyParty[0], SPECIES_ROCKRUFF_OWN_TEMPO, 10);
    LockPlayerFieldControls();
