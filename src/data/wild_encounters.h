...
const struct WildPokemon gJoyces_Dungeon_Main0_LandMons[] =
{
    { 16, 17, SPECIES_PUCANTAE },
    { 16, 16, SPECIES_GASTLY },
    { 16, 16, SPECIES_MISDREAVUS },
    { 16, 16, SPECIES_MISDREAVUS },
    { 16, 16, SPECIES_PUCANTAE },
    { 17, 18, SPECIES_GASTLY },
    { 17, 17, SPECIES_MISDREAVUS },
    { 18, 18, SPECIES_MISDREAVUS },
    { 16, 16, SPECIES_GASTLY },
    { 17, 17, SPECIES_MISDREAVUS },
    { 18, 18, SPECIES_PUCANTAE },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gJoyces_Dungeon_Main0_LandMonsInfo = { 24, gJoyces_Dungeon_Main0_LandMons };
const struct WildPokemon gAtkinsForest0_LandMons[] =
{
    { 16, 16, SPECIES_HOOTHOOT },
    { 16, 16, SPECIES_SKWOVET },
    { 16, 16, SPECIES_BUNNELBY },
    { 16, 16, SPECIES_HOOTHOOT },
    { 17, 17, SPECIES_EMOLGA },
    { 17, 17, SPECIES_BUNNELBY },
    { 16, 16, SPECIES_KAKUNA },
    { 16, 16, SPECIES_METAPOD },
    { 18, 18, SPECIES_BEEDRILL },
    { 18, 18, SPECIES_BUTTERFREE },
    { 15, 15, SPECIES_ROWLET },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gAtkinsForest0_LandMonsInfo = { 24, gAtkinsForest0_LandMons };
const struct WildPokemon gAtkinsTown0_LandMons[] =
{
    { 12, 13, SPECIES_DOTTLER },
    { 12, 12, SPECIES_BUNNELBY },
    { 12, 51, SPECIES_STARLY },
    { 12, 12, SPECIES_STARLY },
    { 12, 12, SPECIES_DOTTLER },
    { 12, 12, SPECIES_BUNNELBY },
    { 14, 14, SPECIES_ORBEETLE },
    { 12, 12, SPECIES_SEWADDLE },
    { 12, 12, SPECIES_SEWADDLE },
    { 13, 13, SPECIES_SWADLOON },
    { 12, 14, SPECIES_LITTEN },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gAtkinsTown0_LandMonsInfo = { 24, gAtkinsTown0_LandMons };
const struct WildPokemon gLiathbearradhCity0_LandMons[] =
{
    { 9, 10, SPECIES_HOPPIP },
    { 9, 10, SPECIES_ODDISH },
    { 9, 10, SPECIES_BUNNELBY },
    { 9, 10, SPECIES_HOPPIP },
    { 9, 10, SPECIES_SKIDDO },
    { 5, 5, SPECIES_STARLY },
    { 9, 10, SPECIES_STARLY },
    { 9, 10, SPECIES_AZURILL },
    { 9, 10, SPECIES_DWEBBLE },
    { 10, 11, SPECIES_SKIPLOOM },
    { 9, 10, SPECIES_APPLIN },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gLiathbearradhCity0_LandMonsInfo = { 21, gLiathbearradhCity0_LandMons };
const struct WildPokemon gLiathbearradhCity0_WaterMons[] =
{
    { 5, 5, SPECIES_MARILL },
    { 5, 5, SPECIES_PSYDUCK },
    { 5, 5, SPECIES_PSYDUCK },
...
const struct WildPokemonInfo gLiathbearradhCity0_WaterMonsInfo = { 0, gLiathbearradhCity0_WaterMons };
const struct WildPokemon gLiathbearradhCity0_FishingMons[] =
{
    ...
    { 5, 5, SPECIES_MAGIKARP },
    { 5, 5, SPECIES_MAGIKARP },
    { 5, 5, SPECIES_RELICANTH },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gLiathbearradhCity0_FishingMonsInfo = { 0, gLiathbearradhCity0_FishingMons };
const struct WildPokemon gRoute2_0_LandMons[] =
{
    { 7, 10, SPECIES_RUFFLET },
    { 5, 6, SPECIES_DWEBBLE },
    { 7, 9, SPECIES_SKIDDO },
    { 8, 10, SPECIES_SANDSHREW },
    { 9, 11, SPECIES_RUFFLET },
    { 6, 7, SPECIES_DWEBBLE },
    { 9, 11, SPECIES_SKIDDO },
    { 9, 11, SPECIES_SANDSHREW },
    { 9, 11, SPECIES_SANDSHREW },
    { 10, 10, SPECIES_SANDSHREW },
    { 5, 5, SPECIES_LARVITAR },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gRoute2_0_LandMonsInfo = { 28, gRoute2_0_LandMons };
const struct WildPokemon gRoute2_0_WaterMons[] =
{
    { 5, 5, SPECIES_NONE },
    { 5, 5, SPECIES_NONE },
    { 5, 5, SPECIES_NONE },
...
const struct WildPokemonInfo gRoute2_0_WaterMonsInfo = { 0, gRoute2_0_WaterMons };
const struct WildPokemon gRoute2_0_FishingMons[] =
{
    { 5, 5, SPECIES_NONE },
    { 5, 5, SPECIES_NONE },
    { 5, 5, SPECIES_NONE },
...
const struct WildPokemonInfo gRoute2_0_FishingMonsInfo = { 0, gRoute2_0_FishingMons };
const struct WildPokemon gRoute2_1_LandMons[] =
{
    { 12, 14, SPECIES_SANDSHREW },
    { 12, 14, SPECIES_GEODUDE },
    { 13, 14, SPECIES_GEODUDE },
    { 13, 14, SPECIES_SANDSHREW },
    { 12, 14, SPECIES_NOSEPASS },
    { 13, 14, SPECIES_RUFFLET },
    { 13, 14, SPECIES_RUFFLET },
    { 12, 14, SPECIES_CUBONE },
    { 12, 14, SPECIES_CUBONE },
    { 5, 5, SPECIES_LARVITAR },
...
const struct WildPokemonInfo gRoute2_1_LandMonsInfo = { 21, gRoute2_1_LandMons };
const struct WildPokemon gRoute_2_Cave0_LandMons[] =
{
    { 12, 14, SPECIES_GEODUDE },
    { 12, 12, SPECIES_ZUBAT },
    { 12, 12, SPECIES_ZUBAT },
    { 12, 12, SPECIES_ZUBAT },
    { 14, 14, SPECIES_GRAVELER },
    { 12, 14, SPECIES_NOSEPASS },
    { 12, 13, SPECIES_GEODUDE },
    { 5, 5, SPECIES_GEODUDE },
    { 5, 5, SPECIES_GEODUDE },
    { 5, 5, SPECIES_GEODUDE },
    { 5, 5, SPECIES_GEODUDE },
...
const struct WildPokemonInfo gRoute_2_Cave0_LandMonsInfo = { 28, gRoute_2_Cave0_LandMons };
const struct WildPokemon gRoute_40_LandMons[] =
{
    { 13, 13, SPECIES_WOOLOO },
    { 13, 13, SPECIES_SPOINK },
    { 13, 13, SPECIES_MAREEP },
    { 13, 13, SPECIES_NICKIT },
    { 13, 13, SPECIES_WOOLOO },
    { 14, 14, SPECIES_FLAAFFY },
    { 13, 14, SPECIES_NICKIT },
    { 13, 13, SPECIES_NICKIT },
    { 12, 12, SPECIES_TAUROS },
    { 12, 12, SPECIES_MILTANK },
    { 13, 13, SPECIES_VULPIX },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gRoute_40_LandMonsInfo = { 28, gRoute_40_LandMons };
const struct WildPokemon gRoute_130_LandMons[] =
{
    { 12, 12, SPECIES_CLAUNCHER },
    { 12, 12, SPECIES_BEOLGIN },
    { 12, 12, SPECIES_BINACLE },
    { 13, 13, SPECIES_BEOLGIN },
    { 13, 13, SPECIES_CLAUNCHER },
    { 12, 12, SPECIES_BINACLE },
    { 13, 13, SPECIES_BINACLE },
    { 13, 13, SPECIES_BINACLE },
    { 13, 13, SPECIES_SANDYGAST },
    { 13, 13, SPECIES_SANDYGAST },
    { 12, 13, SPECIES_POPPLIO },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gRoute_130_LandMonsInfo = { 24, gRoute_130_LandMons };
const struct WildPokemon gTusaTown0_LandMons[] =
{
    { 6, 7, SPECIES_STARLY },
    { 6, 7, SPECIES_ZIGZAGOON_GALARIAN },
    { 6, 7, SPECIES_NIDORAN_M },
    { 6, 7, SPECIES_NIDORAN_F },
    { 7, 7, SPECIES_ZIGZAGOON_GALARIAN },
    { 8, 8, SPECIES_ZIGZAGOON_GALARIAN },
    { 7, 7, SPECIES_STARLY },
    { 8, 9, SPECIES_STARLY },
    { 7, 8, SPECIES_STARLY },
    { 10, 10, SPECIES_ROCKRUFF },
    { 10, 10, SPECIES_ROCKRUFF_OWN_TEMPO },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gTusaTown0_LandMonsInfo = { 21, gTusaTown0_LandMons };
const struct WildPokemon gRoute_10_LandMons[] =
{
    { 5, 5, SPECIES_STARLY },
    { 5, 5, SPECIES_ZIGZAGOON_GALARIAN },
    ...
    { 5, 5, SPECIES_ROCKRUFF_OWN_TEMPO },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gRoute_10_LandMonsInfo = { 21, gRoute_10_LandMons };
const struct WildPokemon gClearcurrent_City0_LandMons[] =
{
    { 16, 16, SPECIES_WINGULL },
    { 16, 16, SPECIES_PIDOVE },
    { 16, 51, SPECIES_WINGULL },
    { 16, 17, SPECIES_PIDOVE },
    { 16, 16, SPECIES_PURRLOIN },
    { 16, 16, SPECIES_NICKIT },
    { 16, 17, SPECIES_PURRLOIN },
    { 17, 18, SPECIES_TRANQUILL },
    { 18, 18, SPECIES_PIKACHU },
    { 18, 20, SPECIES_PELIPPER },
    { 17, 17, SPECIES_EEVEE },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gClearcurrent_City0_LandMonsInfo = { 21, gClearcurrent_City0_LandMons };
const struct WildPokemon gAtkins_Lake0_LandMons[] =
{
    { 16, 16, SPECIES_BUIZEL },
    { 16, 16, SPECIES_MIENFOO },
    { 15, 15, SPECIES_SKWOVET },
    { 16, 16, SPECIES_BUNNELBY },
    { 16, 18, SPECIES_DUCKLETT },
    { 16, 17, SPECIES_MIENFOO },
    { 17, 17, SPECIES_SKWOVET },
    { 17, 17, SPECIES_BUIZEL },
    { 16, 16, SPECIES_DUCKLETT },
    { 18, 18, SPECIES_YANMA },
    { 15, 15, SPECIES_ROWLET },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gAtkins_Lake0_LandMonsInfo = { 21, gAtkins_Lake0_LandMons };
const struct WildPokemon gAtkins_Lake0_FishingMons[] =
{
    { 5, 5, SPECIES_NONE },
    { 5, 5, SPECIES_NONE },
    { 5, 5, SPECIES_NONE },
...
const struct WildPokemonInfo gAtkins_Lake0_FishingMonsInfo = { 0, gAtkins_Lake0_FishingMons };
const struct WildPokemon gRoute10_LandMons[] =
{
    { 5, 5, SPECIES_ZIGZAGOON_GALARIAN },
    { 5, 5, SPECIES_STARLY },
    { 5, 5, SPECIES_NIDORAN_M },
...
const struct WildPokemonInfo gRoute10_LandMonsInfo = { 21, gRoute10_LandMons };
const struct WildPokemon gRoute_50_LandMons[] =
{
    { 15, 15, SPECIES_WINGULL },
    { 15, 15, SPECIES_MAREEP },
    { 15, 15, SPECIES_SPOINK },
    { 16, 16, SPECIES_WOOLOO },
    { 16, 16, SPECIES_MAREEP },
    { 16, 16, SPECIES_WOOLOO },
    { 16, 16, SPECIES_SPOINK },
    { 18, 51, SPECIES_GRUMPIG },
    { 18, 18, SPECIES_FLAAFFY },
    { 18, 18, SPECIES_DUBWOOL },
    { 15, 15, SPECIES_VULPIX },
    { 5, 5, SPECIES_NONE },
};

const struct WildPokemonInfo gRoute_50_LandMonsInfo = { 21, gRoute_50_LandMons };
...
const struct WildPokemonHeader gWildMonHeaders[] =
{
    ...
    {
        .mapGroup = MAP_GROUP(JOYCES_DUNGEON_MAIN),
        .mapNum = MAP_NUM(JOYCES_DUNGEON_MAIN),
        .landMonsInfo = &gJoyces_Dungeon_Main0_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        .mapGroup = MAP_GROUP(ATKINS_FOREST),
        .mapNum = MAP_NUM(ATKINS_FOREST),
        .landMonsInfo = &gAtkinsForest0_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        .mapGroup = MAP_GROUP(ATKINS_TOWN),
        .mapNum = MAP_NUM(ATKINS_TOWN),
        .landMonsInfo = &gAtkinsTown0_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        .mapGroup = MAP_GROUP(LIATHBEARRADH_CITY),
        .mapNum = MAP_NUM(LIATHBEARRADH_CITY),
        .landMonsInfo = &gLiathbearradhCity0_LandMonsInfo,
        .waterMonsInfo = &gLiathbearradhCity0_WaterMonsInfo,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = &gLiathbearradhCity0_FishingMonsInfo,
    },
    {
        .mapGroup = MAP_GROUP(ROUTE2),
        .mapNum = MAP_NUM(ROUTE2),
        .landMonsInfo = &gRoute2_0_LandMonsInfo,
        .waterMonsInfo = &gRoute2_0_WaterMonsInfo,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = &gRoute2_0_FishingMonsInfo,
    },
    {
        .mapGroup = MAP_GROUP(ROUTE2),
        .mapNum = MAP_NUM(ROUTE2),
        .landMonsInfo = &gRoute2_1_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        .mapGroup = MAP_GROUP(ROUTE_2_CAVE),
        .mapNum = MAP_NUM(ROUTE_2_CAVE),
        .landMonsInfo = &gRoute_2_Cave0_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        ...
        .landMonsInfo = &gRoute_40_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        ...
        .landMonsInfo = &gRoute_130_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        .mapGroup = MAP_GROUP(TUSA_TOWN),
        .mapNum = MAP_NUM(TUSA_TOWN),
        .landMonsInfo = &gTusaTown0_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        ...
        .landMonsInfo = &gRoute_10_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        .mapGroup = MAP_GROUP(CLEARCURRENT_CITY),
        .mapNum = MAP_NUM(CLEARCURRENT_CITY),
        .landMonsInfo = &gClearcurrent_City0_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
    {
        .mapGroup = MAP_GROUP(ATKINS_LAKE),
        .mapNum = MAP_NUM(ATKINS_LAKE),
        .landMonsInfo = &gAtkins_Lake0_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = &gAtkins_Lake0_FishingMonsInfo,
    },
    {
    ...
    },
    {
        ...
        .landMonsInfo = &gRoute_50_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
