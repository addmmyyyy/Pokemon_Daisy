...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(ROUTE_1), MAP_NUM(ROUTE_1), 12, 16},
    ...
    [HEAL_LOCATION_ATKINS_TOWN - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED), 0, 0},
    [HEAL_LOCATION_CLEARCURRENT_CITY - 1] = {MAP_GROUP(CLEARCURRENT_CITY), MAP_NUM(CLEARCURRENT_CITY), 41, 14},
    [HEAL_LOCATION_LIATHBEARRADH_CITY - 1] = {MAP_GROUP(LIATHBEARRADH_CITY), MAP_NUM(LIATHBEARRADH_CITY), 35, 27},
    [HEAL_LOCATION_TUSA_TOWN - 1] = {MAP_GROUP(TUSA_TOWN), MAP_NUM(TUSA_TOWN), 14, 12},
};
