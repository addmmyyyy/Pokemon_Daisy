static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CLEARCURRENT_CITY - 1] = {MAP_GROUP(CLEARCURRENT_CITY), MAP_NUM(CLEARCURRENT_CITY), 28, 17},
    [HEAL_LOCATION_LIATHBEARRADH_CITY - 1] = {MAP_GROUP(LIATHBEARRADH_CITY), MAP_NUM(LIATHBEARRADH_CITY), 38, 22},
    [HEAL_LOCATION_TUSA_TOWN - 1] = {MAP_GROUP(TUSA_TOWN), MAP_NUM(TUSA_TOWN), 15, 15},
};
