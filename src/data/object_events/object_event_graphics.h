...
const u32 gObjectEventPic_Wooloo[] = INCBIN_U32("graphics/object_events/pics/pokemon/wooloo_sprites.4bpp");
const u16 gObjectEventPalette_Wooloo[] = INCBIN_U16("graphics/object_events/palettes/wooloo.gbapal");
