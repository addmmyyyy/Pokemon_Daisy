...
#define SPECIES_PUCANTAE SPECIES_CALYREX_SHADOW_RIDER + 1
#define SPECIES_BEOLGIN SPECIES_CALYREX_SHADOW_RIDER + 2
#define SPECIES_EGG SPECIES_CALYREX_SHADOW_RIDER + 3
